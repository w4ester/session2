...
- **LinkedIn App Name:** `[YOUR_APP_NAME]` (e.g., "My LinkedIn GPT")
- **LinkedIn App ID:** `[YOUR_APP_ID]` (you'll get this after creating the app)
...
> **Example app name:** "My LinkedIn Post GPT" or "[Your Name]'s LinkedIn Assistant"
...
1. Open your app **Settings** → `My apps → [Your App Name] → Settings`
   Direct link format: `https://www.linkedin.com/developers/apps/[YOUR_APP_ID]/settings`
2. Under **LinkedIn Page**, associate your Page and send a **verification request**.
3. A **Page Admin** (or higher) must approve the request (you can be that person).
   - Help:
...
> **Note:** Verification usually takes 1-2 minutes if you're the Page Admin.

---

## Step 3 — Add the two required Products (permissions)

Open your app's **Products** tab → `https://www.linkedin.com/developers/apps/[YOUR_APP_ID]/products`
...
Click **Request access** for each product. Approval is usually instant.
...
- Open: `https://www.linkedin.com/developers/apps/[YOUR_APP_ID]/auth`
- Copy your **Client ID** (visible)
- Click **Show** to reveal your **Client Secret** and copy it (keep this private!)
- Under **Authorized redirect URLs**, add your GPT callback URL exactly:
  `https://chat.openai.com/aip/g-[YOUR_GPT_ID]/oauth/callback`
  (You'll get this from your GPT editor → Actions → OAuth section)
